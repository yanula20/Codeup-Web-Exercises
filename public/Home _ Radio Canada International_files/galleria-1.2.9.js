            ...
            show: function (index) {
                ...
                lightbox.image.load(data.iframe || data.big || data.image, function (image) {
                    ...
                    if (data.title && data.description) {
                        lightbox.elems.title.innerHTML = data.title + "<div class='descLightbox'>" + data.description + "</div>";
                    }
                    else if (data.title) {
                        lightbox.elems.title.innerHTML = data.title;
                    }
                    else if (data.description) {
                        lightbox.elems.title.innerHTML = "<div class='descLightbox'>" + data.description + "</div>";
                    }
